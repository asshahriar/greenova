    ...
    <section id="contact" className="bg-[#dfdfdf] py-20 md:py-24">
      <div className="container">
        <div className="grid items-start gap-12 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-16 xl:gap-20">
          <Reveal className="pt-1">
            ...
            <ul className="mt-14 space-y-8">
              {contactItems.map((item) => {
                ...
                return (
                  <li key={item.label} className="flex items-start gap-4 rounded-xl transition duration-300 hover:translate-x-1">
                    <span className="inline-flex size-12 shrink-0 items-center justify-center rounded-[10px] bg-tertiary text-dark transition duration-300 hover:bg-dark hover:text-light">
                    ...
                    <div className="pt-0.5">
                      ...
                      <a
                        ...
                        className="mt-1 block text-[clamp(1.02rem,0.35vw+0.84rem,1.3rem)] leading-[1.35] text-dark/75 transition duration-300 hover:text-dark"
                      >
                        {item.value}
                      </a>
                    </div>
            ...
            <div className="mt-14">
              ...
              <div className="mt-4 flex items-center gap-5 text-dark">
                <a
                  ...
                  aria-label="TikTok"
                  className="transition duration-300 hover:-translate-y-0.5 hover:text-dark/70"
                >
          ...
          <Reveal delay={0.1} className="rounded-3xl bg-[#ececec] p-5 shadow-[0_6px_24px_rgba(6,17,13,0.06)] sm:p-7 lg:p-8">
            <form className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="mt-2 h-13 w-full rounded-[9px] border border-dark/10 bg-[#dfdfdf] px-4 text-[clamp(1rem,0.34vw+0.88rem,1.25rem)] text-dark outline-none transition duration-300 focus:border-dark/25 focus:bg-light"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  id="contact-message"
                  name="message"
                  className="mt-2 min-h-[205px] w-full resize-none rounded-[9px] border border-dark/10 bg-[#dfdfdf] px-4 py-3 text-[clamp(1rem,0.34vw+0.88rem,1.25rem)] text-dark outline-none transition duration-300 focus:border-dark/25 focus:bg-light"
                />
              </div>
