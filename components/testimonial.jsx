  ...
  return (
    <section id="testimonial" className="bg-secondary py-20 md:py-24">
      <div className="container">
        ...
        <Reveal delay={0.12}>
          <div className="mt-12 rounded-3xl bg-light px-5 py-14 shadow-[0_4px_20px_rgba(6,17,13,0.04)] sm:px-8 md:min-h-[640px] md:px-12 md:py-20">
            <div className="mx-auto flex max-w-3xl flex-col items-center justify-center text-center md:min-h-[480px]">
              ...
              <div className="mt-8 flex items-center gap-2.5">
                {customerAvatars.map((avatar) => (
                  <div
                    key={avatar.alt}
                    className={`relative size-12 overflow-hidden rounded-full transition duration-300 hover:-translate-y-1 ${
                      avatar.active
                  ...
                  >
                    <Image
                      ...
                      className={`object-cover transition duration-500 ${
                        avatar.active ? "" : "grayscale hover:grayscale-0"
                      }`}
                    />
                  </div>
                ))}
